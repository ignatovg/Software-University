...
namespace P06_1TargetPractice
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //int correction = 0;
            //for (int r = shotRow; r <= shotRow + radius; r++)
            //{
            //    for (int c = shotColumn - radius + correction; c <= shotColumn + radius - correction; c++)
            //    {

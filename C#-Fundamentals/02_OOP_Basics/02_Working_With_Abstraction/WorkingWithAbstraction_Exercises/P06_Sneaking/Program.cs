    ...
    class Sneaking
    {
        ...
        static void Main()
        {
            ...
            for (int i = 0; i < moves.Length; i++)
            {
                ...
                if (CheckIsNikoladzeKilled(getEnemy))
                {
                    Environment.Exit(0);
                }
            }
        ...
        private static bool CheckIsNikoladzeKilled(int[] getEnemy)
        {
        ...
        private static bool CheckIsSamDead(int[] getEnemy)
        {

...
namespace BashSoft.Static_data
{
    ...
    {
        //public const string DataAlreadyInitialisedException = "Data is already intialized!";
        ...
        public const string UnableToGoHigherInPartitionHierarchy = "You cannot go higher in the hierarchy";
        ...
        //public const string StudentAlreadEnrolledInGivenCourse = "The {0} already exists in {1}.";
        ...
        public const string InvalidScore = "The number for the score you've entered is not in range of 0 - 100.";

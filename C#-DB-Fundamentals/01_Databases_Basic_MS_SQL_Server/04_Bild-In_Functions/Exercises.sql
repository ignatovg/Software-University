...
--Problem 11.	 Mix of Peak and River Names UFINISHED
SELECT p.PeakName,
		r.RiverName, 
...
Name
 ...
 SELECT Username,
		SUBSTRING(Email,CHARINDEX('@',Email,1) +1,99) AS [Email Provider]
  FROM Users
  ...
  SELECT Name AS Game,
		...
		WHEN DATEPART(HOUR, Start) BETWEEN 18 AND 23 THEN 'Evenning'
 ...
 ('Joro','1997-02-07 00:00:00.000')

 INSERT INTO People (Name, Birthdate)
 VALUES('Maria','1968-07-25')
